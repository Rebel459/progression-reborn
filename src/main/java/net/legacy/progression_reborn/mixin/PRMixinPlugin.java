...
// import net.legacy.unified.platform.UnifiedPlatform;
...
public final class PRMixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, @NotNull String mixinClassName) {
        ...
        if (mixinClassName.contains("integration.farmersdelight")) return FabricLoader.getInstance().isModLoaded("farmersdelight");
        // if (mixinClassName.contains("integration.item_tooltips")) return FabricLoader.getInstance().isModLoaded("item_tooltips");

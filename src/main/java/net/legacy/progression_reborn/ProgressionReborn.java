...
public class ProgressionReborn implements ModInitializer {
	...
	public void onInitialize() {
		...
		if (PRConfig.get.generation.modified_overworld_ores) {
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "modified_overworld_ores"), modContainer.get(),
		...
		if (PRConfig.get.generation.modified_nether_ores) {
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "modified_nether_ores"), modContainer.get(),
		...
		if (PRConfig.get.misc.retextured_iron_equipment) {
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "retextured_iron_equipment"), modContainer.get(),
		...
		if (FabricLoader.getInstance().isModLoaded("farmersdelight") && FabricLoader.getInstance().isModLoaded("farmersknives") && PRConfig.get.integrations.farmers_delight) {
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "progression_reborn_farmers_delight_integration"), modContainer.get(),
		...
		if (FabricLoader.getInstance().isModLoaded("legacies_and_legends") && PRConfig.get.integrations.legacies_and_legends) {
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "progression_reborn_legacies_and_legends_integration"), modContainer.get(),
		...
		if (FabricLoader.getInstance().isModLoaded("end_reborn") && PRConfig.get.integrations.end_reborn) {
			...
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "progression_reborn_end_reborn_integration"), modContainer.get(),
		...
		if (FabricLoader.getInstance().isModLoaded("wilderwild") && PRConfig.get.integrations.wilder_wild) {
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "progression_reborn_wilder_wild_integration"), modContainer.get(),
		...
		if (FabricLoader.getInstance().isModLoaded("trailiertales") && PRConfig.get.integrations.trailier_tales) {
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "progression_reborn_trailier_tales_integration"), modContainer.get(),
		...
		if (FabricLoader.getInstance().isModLoaded("remnants") && PRConfig.get.integrations.remnants) {
			ResourceManagerHelper.registerBuiltinResourcePack(
                    Identifier.fromNamespaceAndPath(PRConstants.MOD_ID, "progression_reborn_remnants_integration"), modContainer.get(),

...
import net.rebel459.progression_reborn.registry.PRTrimMaterials;
...
public class PRRegistryProvider extends FabricDynamicRegistryProvider {
    protected PRRegistryProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
